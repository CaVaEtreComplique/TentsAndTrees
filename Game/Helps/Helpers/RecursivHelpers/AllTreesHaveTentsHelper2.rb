...
require File.dirname(__FILE__) + "/../../HelpClasses/HelpsOnCells/HelpsOn2Cells/HelpOn2CellUniqueSolution/HelpsOn2CellUniqueSolution"

class AllTreesHaveTentsHelper2 < FictivHelper
    ...
    tree.each() do |cell|
      ...
      if !treeAlreadySeen.include?(cell)
        ...
        if nbTree > nbTent && !answer.nil?
          ...
          return HelpsOn2CellUniqueSolution.new(answer, cell)
        end
