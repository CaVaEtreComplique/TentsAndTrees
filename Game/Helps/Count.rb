...
##
# ==== Presentation
# The Count class gives some extended methods to the Game class.
#
# ==== Methods
# This class knows the count and findFirst method described below.
class Count
  # ==== Presentation
  ...
  # * +vertHor+ - The orientation, put 0 if we are looking for a row, otherwise it will look for a column.
  # * +rank+ - The row or column number we want to do our research in.
  #
  # ===== Returns
  # This method returns the number of cells who are in the specified state
  ...
  # ===== Presentation
  # This class method finds the first cell who is in a certain state
  # inside a row or column.
  #
  # ===== Attributes
  # * +game+ - The Game we are going to research in.
